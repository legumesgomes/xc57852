...
define( 'YOURLS_DB_USER', 'bio6_hallo' );

/** MySQL database password */
define( 'YOURLS_DB_PASS', 'qCiB2-uBiu+pJ!%F' );

/** The name of the database for YOURLS
 ** Use lower case letters [a-z], digits [0-9] and underscores [_] only */
define( 'YOURLS_DB_NAME', 'bio6_hallo' );
...
define( 'YOURLS_SITE', 'https://bio6.click' );
...
$yourls_user_passwords = [
	'admin' => 'phpass:!2y!10!cy8VlIV9DYz/rAqZo67Pz.ptXmXX5cyXNpkJ4VojO/sd5biLYRcHW' /* Password encrypted by YOURLS */ ,
	// 'username2' => 'password2',
